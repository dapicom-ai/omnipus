...
Le canal MaixCam permet à Omnipus de fonctionner comme backend IA pour les appareils en périphérie :

- **Surveillance intelligente** : MaixCAM envoie des images ; Omnipus les analyse via des modèles de vision
- **Contrôle IoT** : Les appareils envoient des données de capteurs ; Omnipus coordonne les réponses
- **IA hors ligne** : Déployer Omnipus sur un réseau local pour une inférence à faible latence
