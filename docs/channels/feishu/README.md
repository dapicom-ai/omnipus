...
5. Fill in the App ID and App Secret in the Omnipus configuration file
6. Run `omnipus gateway` to start the service
7. Search for the bot name in Feishu and start a conversation

> Omnipus connects to Feishu using WebSocket/SDK mode — no public callback address or Webhook URL is required.
>
