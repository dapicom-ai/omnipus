...
O Omnipus oferece suporte ao QQ via API Bot oficial da Plataforma Aberta QQ.
...
3. Preencha as credenciais no arquivo de configuração do Omnipus
4. Execute `omnipus gateway` para iniciar o serviço
...
4. Preencha as credenciais no arquivo de configuração do Omnipus
5. Execute `omnipus gateway` para iniciar o serviço
