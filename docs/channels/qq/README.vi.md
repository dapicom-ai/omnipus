...
Omnipus hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình Omnipus
4. Chạy `omnipus gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình Omnipus
5. Chạy `omnipus gateway` để khởi động dịch vụ
