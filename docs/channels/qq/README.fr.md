...
Omnipus prend en charge QQ via l'API Bot officielle de la plateforme ouverte QQ.
...
3. Renseigner les identifiants dans le fichier de configuration Omnipus
4. Exécuter `omnipus gateway` pour démarrer le service
...
4. Renseigner les identifiants dans le fichier de configuration Omnipus
5. Exécuter `omnipus gateway` pour démarrer le service
