...
Omnipus は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. Omnipus 設定ファイルに認証情報を入力する
4. `omnipus gateway` を実行してサービスを起動する
...
4. Omnipus 設定ファイルに認証情報を入力する
5. `omnipus gateway` を実行してサービスを起動する
