...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open Omnipus console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About Omnipus",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit Omnipus",
		Exiting:            "Exiting Omnipus...",
		DocUrl:             "https://docs.omnipus.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 Omnipus 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 Omnipus",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 Omnipus",
		Exiting:            "正在退出 Omnipus...",
		DocUrl:             "https://docs.omnipus.io/zh-Hans/docs/",
	},
}
