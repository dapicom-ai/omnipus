...
type ExecProxyStatus struct {
	// Address Bound address in "host:port" format. Present only when running is true.
...
type ServerInterface interface {
	...
	ListAgentSessions(w http.ResponseWriter, r *http.Request, id string)
	// Get per-agent tool registry view and effective policies
	// (GET /agents/{id}/tools)
	GetAgentTools(w http.ResponseWriter, r *http.Request, id string)
	// Replace per-agent tool policy configuration
	// (PUT /agents/{id}/tools)
	UpdateAgentTools(w http.ResponseWriter, r *http.Request, id string)
	// Get recent audit log entries
	// (GET /audit-log)
	GetAuditLog(w http.ResponseWriter, r *http.Request)
	...
	// (GET /channels/{id})
	GetChannelConfig(w http.ResponseWriter, r *http.Request, id string)
	// Configure a channel
	// (PUT /channels/{id}/configure)
	ConfigureChannel(w http.ResponseWriter, r *http.Request, id string)
	// Disable a channel
	// (PUT /channels/{id}/disable)
	DisableChannel(w http.ResponseWriter, r *http.Request, id string)
	// Enable a channel
	// (PUT /channels/{id}/enable)
	EnableChannel(w http.ResponseWriter, r *http.Request, id string)
	// Test a channel configuration
	// (POST /channels/{id}/test)
	TestChannel(w http.ResponseWriter, r *http.Request, id string)
	// Get pending restart-gated config changes (admin only)
	// (GET /config/pending-restart)
	GetPendingRestart(w http.ResponseWriter, r *http.Request)
	// List credential key names
	// (GET /credentials)
	ListCredentials(w http.ResponseWriter, r *http.Request)
	// Add or update a credential
	// (POST /credentials)
	SetCredential(w http.ResponseWriter, r *http.Request)
	// Delete a credential
	...
	// (POST /onboarding/probe-provider)
	ProbeProvider(w http.ResponseWriter, r *http.Request)
	...
	GetAuditLogToggle(w http.ResponseWriter, r *http.Request)
	// Enable or disable audit logging (admin only)
	// (PUT /security/audit-log)
	UpdateAuditLogToggle(w http.ResponseWriter, r *http.Request)
	// Get exec binary allowlist (SEC-05)
	// (GET /security/exec-allowlist)
	GetExecAllowlist(w http.ResponseWriter, r *http.Request)
	// Update exec binary allowlist (SEC-05)
	// (PUT /security/exec-allowlist)
	UpdateExecAllowlist(w http.ResponseWriter, r *http.Request)
	// Get exec SSRF proxy runtime state (SEC-28)
	// (GET /security/exec-proxy-status)
	GetExecProxyStatus(w http.ResponseWriter, r *http.Request)
	// Get prompt injection guard level
	// (GET /security/prompt-guard)
	GetPromptGuard(w http.ResponseWriter, r *http.Request)
	// Update prompt injection guard level (admin only)
	// (PUT /security/prompt-guard)
	UpdatePromptGuard(w http.ResponseWriter, r *http.Request)
	// Get rate limit configuration and live daily cost
	// (GET /security/rate-limits)
	GetRateLimits(w http.ResponseWriter, r *http.Request)
	// Update rate limit configuration (admin only)
	// (PUT /security/rate-limits)
	UpdateRateLimits(w http.ResponseWriter, r *http.Request)
	...
	// (PUT /security/retention)
	UpdateRetention(w http.ResponseWriter, r *http.Request)
	// Trigger on-demand retention sweep (admin only)
	// (POST /security/retention/sweep)
	TriggerRetentionSweep(w http.ResponseWriter, r *http.Request)
	// Get sandbox configuration
	// (GET /security/sandbox-config)
	GetSandboxConfig(w http.ResponseWriter, r *http.Request)
	// Update sandbox configuration (admin only)
	// (PUT /security/sandbox-config)
	UpdateSandboxConfig(w http.ResponseWriter, r *http.Request)
	// Get sandbox backend runtime status (SEC-01/02/03)
	// (GET /security/sandbox-status)
	GetSandboxStatus(w http.ResponseWriter, r *http.Request)
	// Get the current DM session scoping strategy
	// (GET /security/session-scope)
	GetSessionScope(w http.ResponseWriter, r *http.Request)
	// Update the DM session scoping strategy
	// (PUT /security/session-scope)
	UpdateSessionScope(w http.ResponseWriter, r *http.Request)
	// Get skill trust level
	// (GET /security/skill-trust)
	GetSkillTrust(w http.ResponseWriter, r *http.Request)
	// Update skill trust level (admin only)
	// (PUT /security/skill-trust)
	UpdateSkillTrust(w http.ResponseWriter, r *http.Request)
	// Get global tool policies
	// (GET /security/tool-policies)
	GetGlobalToolPolicies(w http.ResponseWriter, r *http.Request)
	// Update global tool policies (admin only)
	// (PUT /security/tool-policies)
	UpdateGlobalToolPolicies(w http.ResponseWriter, r *http.Request)
	...
	// (DELETE /sessions/all)
	ClearAllSessions(w http.ResponseWriter, r *http.Request)
	...
	// Rename a session
	// (PUT /sessions/{id})
	RenameSession(w http.ResponseWriter, r *http.Request, id string)
	...
	// (GET /tools)
	GetToolRegistry(w http.ResponseWriter, r *http.Request)
	...
	ResetUserPassword(w http.ResponseWriter, r *http.Request, username string)
	// Change a user's RBAC role
	// (PATCH /users/{username}/role)
	ChangeUserRole(w http.ResponseWriter, r *http.Request, username string)
	// Read a file from an agent's workspace
	// (GET /workspace/{agent_id}/{path})
	GetWorkspaceFile(w http.ResponseWriter, r *http.Request, agentId string, path string)
}
...
func (siw *ServerInterfaceWrapper) GetAbout(w http.ResponseWriter, r *http.Request) {
...
func (siw *ServerInterfaceWrapper) ListAgentSessions(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListAgentSessions(w, r, id)
	}))
...
func (siw *ServerInterfaceWrapper) GetAgentTools(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetAgentTools(w, r, id)
	}))
...
func (siw *ServerInterfaceWrapper) UpdateAgentTools(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateAgentTools(w, r, id)
	}))
...
// GetChannelConfig operation middleware
func (siw *ServerInterfaceWrapper) GetChannelConfig(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetChannelConfig(w, r, id)
	}))
...
// ConfigureChannel operation middleware
func (siw *ServerInterfaceWrapper) ConfigureChannel(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ConfigureChannel(w, r, id)
	}))
...
// DisableChannel operation middleware
func (siw *ServerInterfaceWrapper) DisableChannel(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DisableChannel(w, r, id)
	}))
...
// EnableChannel operation middleware
func (siw *ServerInterfaceWrapper) EnableChannel(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.EnableChannel(w, r, id)
	}))
...
// GetPendingRestart operation middleware
func (siw *ServerInterfaceWrapper) GetPendingRestart(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetPendingRestart(w, r)
	}))
...
func (siw *ServerInterfaceWrapper) ListCredentials(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListCredentials(w, r)
	}))
...
// SetCredential operation middleware
func (siw *ServerInterfaceWrapper) SetCredential(w http.ResponseWriter, r *http.Request) {
...
func (siw *ServerInterfaceWrapper) DeleteCredential(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeleteCredential(w, r, key)
	}))
...
func (siw *ServerInterfaceWrapper) GetPreview(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "agent_id", r.PathValue("agent_id"), &agentId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetPreview(w, r, agentId, token, path)
	}))
...
// GetAuditLogToggle operation middleware
func (siw *ServerInterfaceWrapper) GetAuditLogToggle(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetAuditLogToggle(w, r)
	}))
...
// UpdateAuditLogToggle operation middleware
func (siw *ServerInterfaceWrapper) UpdateAuditLogToggle(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateAuditLogToggle(w, r)
	}))
...
// GetExecAllowlist operation middleware
func (siw *ServerInterfaceWrapper) GetExecAllowlist(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetExecAllowlist(w, r)
	}))
...
// UpdateExecAllowlist operation middleware
func (siw *ServerInterfaceWrapper) UpdateExecAllowlist(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateExecAllowlist(w, r)
	}))
...
// GetExecProxyStatus operation middleware
func (siw *ServerInterfaceWrapper) GetExecProxyStatus(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetExecProxyStatus(w, r)
	}))
...
// GetPromptGuard operation middleware
func (siw *ServerInterfaceWrapper) GetPromptGuard(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetPromptGuard(w, r)
	}))
...
// UpdatePromptGuard operation middleware
func (siw *ServerInterfaceWrapper) UpdatePromptGuard(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdatePromptGuard(w, r)
	}))
...
// GetRateLimits operation middleware
func (siw *ServerInterfaceWrapper) GetRateLimits(w http.ResponseWriter, r *http.Request) {
...
// UpdateRateLimits operation middleware
func (siw *ServerInterfaceWrapper) UpdateRateLimits(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateRateLimits(w, r)
	}))
...
// UpdateRetention operation middleware
func (siw *ServerInterfaceWrapper) UpdateRetention(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateRetention(w, r)
	}))
...
// TriggerRetentionSweep operation middleware
func (siw *ServerInterfaceWrapper) TriggerRetentionSweep(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.TriggerRetentionSweep(w, r)
	}))
...
// GetSandboxConfig operation middleware
func (siw *ServerInterfaceWrapper) GetSandboxConfig(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSandboxConfig(w, r)
	}))
...
// UpdateSandboxConfig operation middleware
func (siw *ServerInterfaceWrapper) UpdateSandboxConfig(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateSandboxConfig(w, r)
	}))
...
func (siw *ServerInterfaceWrapper) GetSandboxStatus(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSandboxStatus(w, r)
	}))
...
// GetSessionScope operation middleware
func (siw *ServerInterfaceWrapper) GetSessionScope(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSessionScope(w, r)
	}))
...
// UpdateSessionScope operation middleware
func (siw *ServerInterfaceWrapper) UpdateSessionScope(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateSessionScope(w, r)
	}))
...
// GetSkillTrust operation middleware
func (siw *ServerInterfaceWrapper) GetSkillTrust(w http.ResponseWriter, r *http.Request) {
...
// UpdateSkillTrust operation middleware
func (siw *ServerInterfaceWrapper) UpdateSkillTrust(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateSkillTrust(w, r)
	}))
...
// GetGlobalToolPolicies operation middleware
func (siw *ServerInterfaceWrapper) GetGlobalToolPolicies(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetGlobalToolPolicies(w, r)
	}))
...
// UpdateGlobalToolPolicies operation middleware
func (siw *ServerInterfaceWrapper) UpdateGlobalToolPolicies(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.UpdateGlobalToolPolicies(w, r)
	}))
...
// ClearAllSessions operation middleware
func (siw *ServerInterfaceWrapper) ClearAllSessions(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ClearAllSessions(w, r)
	}))
...
// RenameSession operation middleware
func (siw *ServerInterfaceWrapper) RenameSession(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RenameSession(w, r, id)
	}))
...
func (siw *ServerInterfaceWrapper) GetSessionMessages(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSessionMessages(w, r, id)
	}))
...
// PostToolApproval operation middleware
func (siw *ServerInterfaceWrapper) PostToolApproval(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PostToolApproval(w, r, approvalId)
	}))
...
// GetToolRegistry operation middleware
func (siw *ServerInterfaceWrapper) GetToolRegistry(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetToolRegistry(w, r)
	}))
...
// GetBuiltinToolsDeprecated operation middleware
func (siw *ServerInterfaceWrapper) GetBuiltinToolsDeprecated(w http.ResponseWriter, r *http.Request) {
...
func (siw *ServerInterfaceWrapper) ResetUserPassword(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ResetUserPassword(w, r, username)
	}))
...
func (siw *ServerInterfaceWrapper) ChangeUserRole(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ChangeUserRole(w, r, username)
	}))
...
func (siw *ServerInterfaceWrapper) GetWorkspaceFile(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetWorkspaceFile(w, r, agentId, path)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/agents/{id}/tools", wrapper.UpdateAgentTools)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/audit-log", wrapper.GetAuditLog)
	...
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/auth/register-admin", wrapper.RegisterAdmin)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/auth/validate", wrapper.ValidateToken)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/backup", wrapper.CreateBackup)
	...
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/channels/{id}", wrapper.GetChannelConfig)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/channels/{id}/configure", wrapper.ConfigureChannel)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/channels/{id}/disable", wrapper.DisableChannel)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/channels/{id}/enable", wrapper.EnableChannel)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/channels/{id}/test", wrapper.TestChannel)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/config/pending-restart", wrapper.GetPendingRestart)
	...
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/exec-allowlist", wrapper.GetExecAllowlist)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/exec-allowlist", wrapper.UpdateExecAllowlist)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/exec-proxy-status", wrapper.GetExecProxyStatus)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/prompt-guard", wrapper.GetPromptGuard)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/prompt-guard", wrapper.UpdatePromptGuard)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/rate-limits", wrapper.GetRateLimits)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/rate-limits", wrapper.UpdateRateLimits)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/retention", wrapper.GetRetention)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/retention", wrapper.UpdateRetention)
	m.HandleFunc(http.MethodPost+" "+options.BaseURL+"/security/retention/sweep", wrapper.TriggerRetentionSweep)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/sandbox-config", wrapper.GetSandboxConfig)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/sandbox-config", wrapper.UpdateSandboxConfig)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/sandbox-status", wrapper.GetSandboxStatus)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/session-scope", wrapper.GetSessionScope)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/session-scope", wrapper.UpdateSessionScope)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/skill-trust", wrapper.GetSkillTrust)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/skill-trust", wrapper.UpdateSkillTrust)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/security/tool-policies", wrapper.GetGlobalToolPolicies)
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/security/tool-policies", wrapper.UpdateGlobalToolPolicies)
	...
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/sessions/all", wrapper.ClearAllSessions)
	m.HandleFunc(http.MethodDelete+" "+options.BaseURL+"/sessions/{id}", wrapper.DeleteSession)
	...
	m.HandleFunc(http.MethodPut+" "+options.BaseURL+"/users/{username}/password", wrapper.ResetUserPassword)
	m.HandleFunc(http.MethodPatch+" "+options.BaseURL+"/users/{username}/role", wrapper.ChangeUserRole)
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/workspace/{agent_id}/{path}", wrapper.GetWorkspaceFile)
